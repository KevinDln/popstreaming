...
<main>
    ...
    <div class="flex center">
        <form method="POST" action="InscriptionTraitement.php" placeholder="Rechercher un film, une série..." >
            ...
            <br>
            <input class="input-fond-clair form-element" type="email" id="email" name="email" placeholder="Email" required>
            <br>
            <input class=" input-fond-clair form-element" type="date" id="date_naissance" name="date_naissance" placeholder="Date de naissance" required>
            <br>

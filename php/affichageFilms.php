                    ...
                    <div class="flex">
                        ...
                        <div class="contenu" id="contenu" name="contenu">
                            ...
                            for ($i=0; $i <=2; $i++) { // Les lignes
                                for ($j=0; $j < 5 ; $j++) {
                                    if (isset($films[$init]['poster_path'])) {
                                        ...
                                        echo "<a href=\"$url2\"><img src='$img' width='150' height='150' class='poster'> </a>" ;
                                        $total++;
                                    }
                                    $init++;
                                } echo "<br>";
                            ...
                            <?php if (isset($_GET['page']) && $_GET['page'] > 0): ?>
                                <a class="btn-right" href="<?php echo $urlPrecedent?>"><img class="btn-right" src="../Public/img/btn-left.png" alt=""></a>
                            <?php endif; ?>
                            <?php if (!$end): ?>
                                <a class="btn-left" href="<?php echo $urlSuivant?>"><img class="btn-left" src="../Public/img/btn-right.png" alt=""></a>
                            <?php endif; ?>
                        </div>
                    </div>
        </main>

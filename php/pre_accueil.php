        ...
        <div class="slider-container">
            <div class="center flex slider film-list">
                <div class="flex films-tendances">
                    ...
                    <div class="card-film">
                        <img src="../Public/img/film.jpg" alt="">
                ...
                <div class="flex films-tendances">
                    <span class="numerotation-tendances">6</span>
                    <div class="card-film">
                        <img src="../Public/img/film.jpg" alt="">
                        <video class="video-hover" loop muted>
                            <source src="video.mp4" type="video/mp4">
                ...
                <div class="flex films-tendances">
                    <span class="numerotation-tendances">7</span>
                    <div class="card-film">
                        <img src="../Public/img/film.jpg" alt="">
                        <video class="video-hover" loop muted>
                            <source src="video.mp4" type="video/mp4">
                ...
                <div class="flex films-tendances">
                    <span class="numerotation-tendances">8</span>
                    <div class="card-film">
                ...
                <div class="flex films-tendances">
                    <span class="numerotation-tendances">9</span>
                    <div class="card-film">
                        <img src="http://localhost/popstreaming/Public/img/film.jpg" alt="">
                        <video class="video-hover" loop muted>
                            <source src="video.mp4" type="video/mp4">
